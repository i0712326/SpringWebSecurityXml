...
public interface ProductController {
	public ResponseEntity<Entity> uploadImg(String mcc, String mcId, String id, MultipartFile multipartFile) throws MimeTypeException; 
	public ResponseEntity<ProductImg> uploadRelateImg(String mcc, String mcId, String id, MultipartFile multipartFile) throws MimeTypeException;
